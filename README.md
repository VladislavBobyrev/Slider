...
<p align="center">
 Слайдер на JavaScript and CSS  6угольная конструксия перемешается вокруг своего центра при клике на кнопки, кнопки с эффуктом при наведении.
 На сайте есть  MAIN  при открытии на мобильных устройствах он меняет свои размеры и адаптируется что делает пользования конечного клиента оптимальнее. 
  </p>
<h1  align="center">Слайдер</h1>

<div align="center">
  
![Lax 2.0 Gif](https://github.com/VladislavBobyrev/Slider/blob/main/animation.gif)
  
</div>
<h3  align="center">Общие сведения</h3> 
<p align="center">
Размер макета 1440px,  шрфт 'Montserat'16px, клик кнопки сдвигает элемент на одну картинку, они могут двигаться как влево так и вправо

<h4 align="center">Использовались для создания</h4>
